    ...
    <div className="grid grid-cols-1 lg:grid-cols-[minmax(0,0.95fr)_minmax(0,1.05fr)] gap-10 lg:gap-10 items-start">
      <div className="space-y-3">
        ...
        <GuideStepCard
          ...
          detail={
            <>
              导入后下拉名称应显示 <span className="font-semibold">Freesia Petals v5.4</span>。
            </>
          }
        ...
        <GuideStepCard
          ...
          detail={
            <>
              ...
              <span className="font-semibold">Freesia Petals v5.4 QR</span>。
            </>
          }
            ...
            >
              <div className="flex items-center gap-2 min-w-0 relative group">
                <span className="flex items-center gap-1 min-w-0">
                  <span className="truncate">Freesia Petals v5.4 QR</span>
                  <ChevronDown
                    size={14}
